...
var hex_char=eval('"' + args[1] + '"')
//console.log(hex_char,"  xxxx");

result =encry_czq(args[0],hex_char,args[2]);
//2954c637de599a43c8584205923f68b1  \x00\x00\x00\x00\xb7\x23\xc2\x72 netx  1
console.log(result);
//return result