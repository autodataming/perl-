...
function ptuiCB(t, e, i, n, o) {
    ...
    if (0 != t && a && pt.plogin.show_err(o, s), !pt.plogin.hasCheck && a && (pt.plogin.needShowNewVc || pt.plogin.showVC(), $('verifycode').focus(), $('verifycode').select()), Math.random() < 0.2) {
...
set: function (t, e, i, n, o) {
    var r = new Date;
    o ? (r.setTime(r.getTime() + 3600000 * o), document.cookie = t + '=' + e + '; expires=' + r.toGMTString() + '; path=' + (n ? n : '/') + '; ' + (i ? 'domain=' + i + ';' : ''))  : document.cookie = t + '=' + e + '; path=' + (n ? n : '/') + '; ' + (i ? 'domain=' + i + ';' : '')
},
del: function (t, e, i) {
...
if ('undefined' == typeof $.browser.info) {
    ...
    e.version = (e.version && e.version.exec(i) || [0,
    '0']) [1],
    $.browser.info = e
}
...
_find: function (t, e, i) {
    ...
    for (var o = t.document || t, r = o.parentWindow, p = n.length - 1; p >= 0; p--) {
        var a = n[p],
        s = r._allHandlers[a];
        if (s.eventType == e && s.handler == i) return p
    }
    return - 1
},
...
return {
    ...
    str2bin: function (str) {
        for (var arr = [
        ], i = 0; i < str.length; i += 2) arr.push(eval('\'\\x' + str.charAt(i) + str.charAt(i + 1) + '\''));
        return arr.join('')
    },
    ...
    time33: function (t) {
        for (var e = 0, i = 0, n = t.length; n > i; i++) e = (33 * e + t.charCodeAt(i)) % 4294967296;
        return e
    }
}
}(),
...
animate: function (t, e, i, n, o) {
    if (t = $(t)) {
        ...
        for (var m = [
        ], _ = l.length, r = 0; _ > r; r++) m[l[r]] = s[l[r]] < e[l[r]] ? 1 : - 1;
        var v = t.style,
        w = function () {
            for (var n = !0, r = 0; _ > r; r++) s[l[r]] = s[l[r]] + m[l[r]] * Math.abs(e[l[r]] - s[l[r]]) * i / 100,
            (Math.round(s[l[r]]) - e[l[r]]) * m[l[r]] >= 0 ? (n = n && !0, v[l[r]] = e[l[r]] + 'px')  : (n = n && !1, v[l[r]] = s[l[r]] + 'px');
...
needVip: function (t) {
    for (var e = [
        ...
        '549000912',
        '637009801'
    ], i = !0, n = 0, o = e.length; o > n; n++) if (e[n] == t) {
        i = !1;
        break
    }
    return i
...
isdSpeed: function (t, e) {
    ...
    if ($.check.isHttps() && (n = 'https://login.qq.com/cgi-bin/r.cgi?'), n += t, Math.random() < (e || 1)) {
        ...
        for (var r in o) o[r] && o[r] < 30000 && (n += '&' + r + '=' + o[r], i = !0);
        n += '&v=' + Math.random(),
        i && $.http.preload(n)
    }
...
'undefined' != typeof window.postMessage ? $.report.setSpeedPoint(t, 1, 2000)  : $.report.setSpeedPoint(t, 1, 1000),
$.report.isdSpeed(t, 0.01)
}, 500),
$ = window.$ || {
},
$pt = window.$pt || {
...
function v(t) {
    ...
    if (p-- > 0) for (a < this.DB && (i = this[p] >> a) > 0 && (o = !0, r = u(i)); p >= 0; ) e > a ? (i = (this[p] & (1 << a) - 1) << e - a, i |= this[--p] >> (a += this.DB - e))  : (i = this[p] >> (a -= e) & n, 0 >= a && (a += this.DB, --p)),
    i > 0 && (o = !0),
    o && (r += u(i));
    return o ? r : '0'
}
...
function C(t, e) {
    ...
    a = this.s << n & this.DM;
    for (i = this.t - 1; i >= 0; --i) e[i + p + 1] = this[i] >> o | a,
    a = (this[i] & r) << n;
...
function x(t, e) {
    for (var i = 0, n = 0, o = Math.min(t.t, this.t); o > i; ) n += this[i] - t[i],
    e[i++] = n & this.DM,
    n >>= this.DB;
    if (t.t < this.t) {
...
function N(t, e, i) {
    ...
    if (!(n.t <= 0)) {
        ...
        if (0 != g) {
            ...
            null != e && (i.drShiftTo(u, e), s != l && p.ZERO.subTo(e, e)),
            i.t = u,
            i.clamp(),
            c > 0 && i.rShiftTo(c, i),
...
var lt,
ct,
ut = '0123456789abcdefghijklmnopqrstuvwxyz',
gt = new Array;
...
function u(t) {
    for (var e = 16, o = i(t, 0, 4), r = i(t, 4, 4), p = i(f, 0, 4), a = i(f, 4, 4), s = i(f, 8, 4), l = i(f, 12, 4), c = 0, u = 2654435769; e-- > 0; ) c += u,
    c = (4294967295 & c) >>> 0,
    o += (r << 4) + p ^ r + c ^ (r >>> 5) + a,
    o = (4294967295 & o) >>> 0,
    r += (o << 4) + s ^ o + c ^ (o >>> 5) + l,
...
function g(t) {
    for (var e = 16, o = i(t, 0, 4), r = i(t, 4, 4), p = i(f, 0, 4), a = i(f, 4, 4), s = i(f, 8, 4), l = i(f, 12, 4), c = 3816266640, u = 2654435769; e-- > 0; ) r -= (o << 4) + s ^ o + c ^ (o >>> 5) + l,
    r = (4294967295 & r) >>> 0,
    o -= (r << 4) + p ^ r + c ^ (r >>> 5) + a,
    o = (4294967295 & o) >>> 0,
    c -= u,
...
q.encode = function (t) {
    ...
    for (e = 0; a > e; e += 3) i = r(t, e) << 16 | r(t, e + 1) << 8 | r(t, e + 2),
...
function getEncryption(t, e, i, n) {
    i = i || '',
    t = t || '';
    for (var o = n ? t : md5(t), r = hexchar2bin(o), p = md5(r + e), a = $pt.RSA.rsa_encrypt(r), s = (a.length / 2).toString(16), l = TEA.strToBytes(i.toUpperCase(), !0), c = Number(l.length / 2).toString(16); c.length < 4; ) c = '0' + c;
...
S = function () {
    if (a.length = 0, $.suportActive()) try {
        ...
        T(),
        $.report.nlog('IE获取快速登录信息失败：' + f.message, '391626', 0.05)
    } else try {
        var C = $.nptxsso,
        x = C.InitPVA(),
        A = 0;
        ...
        $.report.nlog('非IE获取快速登录信息失败：' + (f.message || f), '391627', 0.05)
    }
},
C = function (t) {
...
A = function (t) {
    ...
    for (var s = 0; n > s; s++) {
        var l = a[s];
        if ((!pt.plogin.authUin || pt.plogin.authUin != l.name && pt.plogin.authUin != l.uinString) && (e.push(l), 5 == e.length)) break
    }
    return p = e,
    e
},
E = function (t) {
    ...
    if (null != a) {
        ...
        for (var m = 0; c > m; m++) {
            ...
            } else e += l.replace(/#uin#/g, v).replace(/#nick#/g, function () {
                return w
...
G = function () {
    for (var t = p.length, e = 0; t > e; e++) p[e].uinString && $.http.loadScript((pt.ptui.isHttps ? 'https://ssl.ptlogin2.' : 'http://ptlogin2.') + pt.ptui.domain + '/getface?appid=' + pt.ptui.appid + '&imgtype=3&encrytype=0&devtype=0&keytpye=0&uin=' + p[e].uinString + '&r=' + Math.random())
},
W = function () {
    z(),
    setTimeout(function () {
...
showAuth: function (t, e) {
    ...
    var i = pt.ptui.style;
    (22 == i || 23 == i) && ($.css.hide($('header')), $.css.hide($('authHeader'))),
...
cancleAuth: function () {
    var t = pt.ptui.style;
    (22 == t || 23 == t) && ($.css.show($('header')), $.css.show($('authHeader'))),
    $.css.hide($('authLogin')),
    pt.plogin.ptui_notifySize('login')
},
authLogin: function () {
...
switchpage: function (t, e) {
    ...
    window.setTimeout(function () {
        try {
            1 == pt.plogin.switchpageCount ? ($('switch_bottom').style.left = i + 'px', $('switch_bottom').style.width = n + 'px')  : $.animate.animate('switch_bottom', {
                left: i,
                width: n
            }, 80, 20)
        } catch (t) {
...
generateEmailTips: function (t) {
    ...
    for (var n = [
    ], o = 0, r = pt.plogin.knownEmail.length; r > o; o++) n.push(i + '@' + pt.plogin.knownEmail[o]);
    for (var p = [
    ], a = 0, r = n.length; r > a; a++) n[a].indexOf(t) > - 1 && p.push($.str.encodeHtml(n[a]));
...
init: function (t) {
    ...
    pt.ptui.isHttps && (pt.plogin.delayTime = 7000, pt.plogin.delayMonitorId = '294060'),
...
aq_patch: function () {
    Math.random() < 0.05 && !pt.ptui.isHttps && $.http.loadScript('http://mat1.gtimg.com/www/js/common_v2.js', function () {
...
show_err: function (t, e) {
    ...
    e || (pt.plogin.errclock = setTimeout('pt.plogin.hide_err()', 5000))
},
hide_err: function () {
    $.css.hide($('error_tips')),
...
bindEvent: function () {
    ...
    domBindAccount && ($.e.add(domBindAccount, 'click', pt.plogin.bind_account), $.e.add(domBindAccount, 'mouseover', function () {
...
checkTimeout: function () {
    var t = $.str.trim($('u').value);
    ($.check.isQQ(t) || $.check.isQQMail(t)) && (pt.plogin.cap_cd = 0, pt.plogin.salt = $.str.uin2hex(t.replace('@qq.com', '')), pt.plogin.needVc = !0, '1' == pt.ptui.pt_vcode_v1 ? pt.plogin.needShowNewVc = !0 : pt.plogin.showVC(), pt.plogin.isCheckTimeout = !0, pt.plogin.checkRet = 1, pt.plogin.cntCheckTimeout++),
...
submit: function (t) {
    ...
    pt.plogin.isVCSessionTimeOut() && !pt.plogin.needVc ? (pt.plogin.lastCheckAccount = '', pt.plogin.check(), window.setTimeout(function () {
        pt.plogin.submit()
    }, 1000))  : ($.http.loadScript(e), pt.plogin.isdTime['7808-7-2-0'] = (new Date).getTime()),
    !1
},
isVCSessionTimeOut: function () {
    return pt.plogin.checkTime = pt.plogin.checkTime || (new Date).getTime(),
    pt.plogin.submitTime - pt.plogin.checkTime > 1200000 ? ($.report.monitor(330323, 0.05), !0)  : !1
},
...
ptui_speedReport: function (t) {
    if ('msie' == $.browser('type') || 'webkit' == $.browser('type')) {
        ...
        for (var i in t) t[i] > 15000 || t[i] < 0 || (e += '&' + i + '=' + t[i] || 1);
        var n = new Image;
        n.src = e
    }
},
...
begin_qrlogin: function () {
    if (!pt.ptui.lockuin) {
        ...
        e && (e.onload = function () {
            ...
            e.onload = e.onerror = null,
            pt.plogin.set_qrlogin_invalid()
        }, pt.plogin.qrlogin_invalid = !1, e.src = pt.plogin.get_qrlogin_pic())
    }
},
...
showQrTips: function () {
    ...
    if (e = $.css.getOffsetPosition('qrlogin_img'), t = $.css.getOffsetPosition('login'), i.left = e.left - t.left, i.right = $('login').offsetWidth - $('qrlogin_img').offsetWidth - i.left, pt.plogin.hasNoQlogin || (i.left = i.left + $.css.getWidth('qrlogin_img') + 10, $('qr_tips').style.left = i.left + 'px'), $.css.show($('qr_tips')), $('qr_tips_pic').style.opacity = 0, $('qr_tips_pic').style.filter = 'alpha(opacity=0)', $('qr_tips_menban').className = 'qr_tips_menban', pt.plogin.hasNoQlogin) if ($.animate.fade('qr_tips_pic', 100, 2, 20, function () {
...
hideQrTips: function () {
    pt.plogin.isNewQr && (window.clearTimeout(pt.plogin.hideQrTipsClock), $('qr_tips_menban').className = '', $.animate.fade('qr_tips_pic', 0, 5, 20, function () {
...
switch_qrlogin_animate: function () {
    ...
    e = $('web_qr_login_show'),
    i = 0;
    t ? (i = - $('web_login').offsetHeight, $('web_qr_login').style.height = ($('qrlogin').offsetHeight || 265) + 'px', $('qrlogin').style.visibility = 'visible', $('web_login').style.visibility = 'hidden')  : (i = 0, $('web_qr_login').style.height = $('web_login').offsetHeight + 'px', $('web_login').style.visibility = 'visible', $('qrlogin').style.visibility = 'hidden'),
    $.animate.animate(e, {
        top: i
    }, 30, 20)
},
switch_qrlogin: function (t) {
    pt.plogin.isNewQr || (t && t.preventDefault(), pt.plogin.hide_err(), pt.plogin.isQrLogin ? ($('qrlogin').style.visibility = 'hidden', pt.plogin.cancle_qrlogin(), $('qrswitch_logo').title = '二维码登录', $('qrswitch_logo').className = 'qrswitch_logo', $.report.monitor('273368', 0.05))  : ($('qrlogin').style.visibility = 'visible', pt.plogin.go_qrlogin_step(1), $('qrswitch_logo').title = '返回', $('qrswitch_logo').className = 'qrswitch_logo_qr', pt.plogin.begin_qrlogin(), $.report.monitor('273367', 0.05)), pt.plogin.isQrLogin = !pt.plogin.isQrLogin, pt.plogin.switch_qrlogin_animate(), pt.plogin.ptui_notifySize('login'))
},
...
onekeyVerify: function (t, e, i) {
    ...
    if (p) {
        ...
        for (var g = p.getElementsByTagName('span'), d = [
            '占位'
        ], h = 0; h < g.length; h++) g[h].className.indexOf('ov-tips') > - 1 && d.push(g[h]);
        s.onclick = function () {
